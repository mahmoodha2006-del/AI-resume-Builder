function CompactTemplate({
  ...
  return (
    <div className="text-slate-950 text-[13px] leading-snug">
      <header className="text-center border-b border-slate-900 pb-4">
      ...
      <section className="mt-5">
        <h2 className="text-xs font-bold uppercase border-b border-slate-300 pb-1">
          Summary
        </h2>
      ...
      <section className="mt-5">
        ...
        <div className="mt-2 space-y-3">
          {experiences.length > 0 ? (
            ...
            <p className="text-slate-500">Experience will appear here.</p>
          )}
        </div>
      </section>
      ...
      <section className="mt-5">
        ...
        <div className="mt-2 space-y-2">
          {education.length > 0 ? (
            ...
            <p className="text-slate-500">Education will appear here.</p>
          )}
        </div>
      </section>
      ...
      <section className="mt-5">
        ...
        <div className="mt-2 space-y-3">
          {projects.length > 0 ? (
            ...
            <p className="text-slate-500">Projects will appear here.</p>
          )}
        </div>
      </section>
      ...
      <section className="mt-5">
        ...
        <div className="mt-2 space-y-2">
          {certifications.length > 0 ? (
            ...
            <p className="text-slate-500">Certifications will appear here.</p>
          )}
        </div>
      </section>
    </div>
